...
assert.equal(accountRun.ranked_name,'QA fixed account '+tag);
...
assert.ok((await call('/v1/leaderboard?environment=latest')).rows.some(r=>r.display_name==='QA fixed account '+tag));
