...
try {
 ...
 assert.ok(!requests.some(u=>/-pack1growth\.compute\.c-5\.us-east-2\.aws\.neon\.tech|draftrunapi\.compute\.c-5\.us-east-2\.aws\.neon\.tech|\.neonauth\.c-5\.us-east-2\.aws\.neon\.tech/.test(u)),'Production browser uses first-party account/gameplay gateway');
