...
test('user admin filters stay account-scoped',()=>{
  const parsed=userAdminFilters(new URL('https://packone.pro/v1/admin/users?search=%20member%40example.com%20&status=paid'));
  assert.deepEqual(parsed,{search:'member@example.com',status:'paid'});
