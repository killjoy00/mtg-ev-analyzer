...
import {easternDateKey} from '../today-status.mjs';
...
test('every Daily surface uses the same clock through Eastern midnight and DST',()=>{
  for(const fn of [engagementDate,workerDate,growthDate,easternDateKey])assert.equal(fn,gameDateKey);
  for(const [time,day] of [['2026-03-08T04:59:59Z','2026-03-07'],['2026-03-08T05:00:00Z','2026-03-08'],['2026-03-08T07:00:00Z','2026-03-08'],['2026-11-01T05:59:59Z','2026-11-01'],['2026-11-01T06:00:00Z','2026-11-01'],['2026-11-02T04:59:59Z','2026-11-01'],['2026-11-02T05:00:00Z','2026-11-02']])assert.equal(gameDateKey(time),day);
});
