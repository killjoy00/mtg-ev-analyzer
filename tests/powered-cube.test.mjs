...
test('Powered Cube practice URL is isolated from expansion sets', () => {
...
test('Powered Cube Daily uses the existing ranked challenge route', () => {
  const url = new URL(poweredCubeUrl({
    origin: 'https://magic.planitnow.us/',
    mode: 'full',
    daily: '2026-09-08',
...
test('Powered Cube rejects unknown game variants', () => {
