...
await query('INSERT INTO neon_auth."user"(id,name,email,"emailVerified") VALUES($1::uuid,$2,$3,false)',[idemAuth,'QA idempotency',`qa-idempotency-${idemAuth}@example.invalid`]);
