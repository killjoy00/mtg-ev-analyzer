...
assert.match(home, /href="visual-c\\.css\\?v=5"/,'home must bust the CSS cache for the hidden-slot fix');
...
assert.match(adLoader, /data\.tcgplayerSurface='daily_home_banner'/);
