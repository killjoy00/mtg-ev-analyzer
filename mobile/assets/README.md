# Mobile release artwork

Production app artwork is intentionally not generated from placeholders.

Expected final files:

- `images/icon.png` — 1024×1024 square PNG for iOS and legacy Android icon generation
- `images/splash-icon.png` — 1024×1024 transparent PNG for the launch screen
