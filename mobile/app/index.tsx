    ...
    <SafeAreaView style={styles.safe}>
      <ScrollView contentContainerStyle={styles.page}>
        ...
        <View style={styles.hero}>
          <Text style={styles.eyebrow}>PACK ONE MOBILE</Text>
        ...
        >
          <Text style={styles.cardKicker}>TODAY&apos;S DAILY</Text>
          <Text style={styles.cardTitle}>Draft Run</Text>
          <Text style={styles.cardBody}>
            Play the current eight-decision Daily against Pack One&apos;s server-authoritative packs, scoring, and result state.
          </Text>
