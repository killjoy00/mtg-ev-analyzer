...
const sections: ArticleSection[] = [
  ...
  },
  {
    ...
    body: [
      'With the current linear curve, an alternative supported half as strongly as the model leader earns 48 after rounding. An alternative at 90% of the leader’s raw support earns 86.',
      'These examples apply to alternatives only: an exact trophy match still earns 100, however much support the model assigns it.',
    ],
  },
  {
    title: 'Eight picks count equally.',
    body: [
      'The final score is the rounded average of eight decision scores. Difficulty and depth add no hidden bonuses or penalties. Trophy matches are counted separately. Historical results retain their original version and length.',
    ],
  },
  {
