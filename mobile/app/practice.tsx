    ...
    return (
      <SafeAreaView style={styles.safe}>
        <View style={styles.center}>
          ...
          <Text style={styles.body}>Loading practice options…</Text>
        </View>
      </SafeAreaView>
    );
  }
    ...
    return (
      <SafeAreaView style={styles.safe}>
        <View style={styles.center}>
          ...
          <Text style={styles.centerBody}>A free account unlocks unlimited regular Draft Run practice.</Text>
          <Pressable
      ...
      <ScrollView contentContainerStyle={styles.page}>
        <View style={styles.hero}>
          ...
          <Text style={styles.body}>
            Practice uses the same server-authoritative picks and scoring as Pack One Dailies. Practice scores save to your career but do not enter the Daily leaderboard.
          </Text>
        </View>
        ...
        >
          ...
          <Text style={styles.cardAction}>Start practice →</Text>
        </Pressable>
          ...
          {customUnlocked ? (
            <>
              ...
              <Text style={styles.selectionMeta}>
                {selectedSets.length
                  ? String(selectedSets.length) + ' set' + (selectedSets.length === 1 ? '' : 's') + ' selected'
        ...
        <View style={styles.note}>
          ...
          <Text style={styles.body}>
            The app reads practice access from your Pack One account. This screen does not sell, grant, or infer Elite access.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
