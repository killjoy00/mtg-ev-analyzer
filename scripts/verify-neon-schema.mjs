...
const result=await query(`SELECT
  ...
  (SELECT count(*)=4 FROM pg_indexes WHERE indexname IN ('draft_run_serving_window_idx','draft_run_serving_source_idx','draft_run_rating_band_idx','draft_run_rating_serving_lookup_idx')) indexes,
