...
-- 0010 retired two environments and pinned each CHECK to that pair. A third
-- retirement therefore has to replace those constraints rather than add to
-- them, or the new fingerprint would be deleted once and admitted forever
-- after. Every constraint below is dropped and re-created over the full
-- current list, so the policy file stays the single source of truth.
-- statement
...
-- statement
ALTER TABLE draft_run_puzzles ADD CONSTRAINT draft_run_puzzles_supported_set CHECK(encode(sha256(convert_to(lower(set_id),'UTF8')),'hex') NOT IN ('f8272fb2c87fbdf3e6c933649a30f2663ba60983247b85ec223fc22b08358988','79b159b843b0aaba706b57fc165afa2d49c3680c43503ed36af6b4f66cbade5b','ca2b25a9b0e7a993f09d627d5929fb8cbfaa95403ac921f231149dc98ddce93d')) NOT VALID;
-- statement
...
-- statement
ALTER TABLE draft_run_verified_puzzles ADD CONSTRAINT draft_run_verified_puzzles_supported_set CHECK(encode(sha256(convert_to(lower(set_id),'UTF8')),'hex') NOT IN ('f8272fb2c87fbdf3e6c933649a30f2663ba60983247b85ec223fc22b08358988','79b159b843b0aaba706b57fc165afa2d49c3680c43503ed36af6b4f66cbade5b','ca2b25a9b0e7a993f09d627d5929fb8cbfaa95403ac921f231149dc98ddce93d')) NOT VALID;
-- statement
...
-- statement
ALTER TABLE game_result_environments ADD CONSTRAINT game_result_environments_supported_set CHECK(encode(sha256(convert_to(lower(set_id),'UTF8')),'hex') NOT IN ('f8272fb2c87fbdf3e6c933649a30f2663ba60983247b85ec223fc22b08358988','79b159b843b0aaba706b57fc165afa2d49c3680c43503ed36af6b4f66cbade5b','ca2b25a9b0e7a993f09d627d5929fb8cbfaa95403ac921f231149dc98ddce93d')) NOT VALID;
-- statement
...
-- statement
ALTER TABLE game_results ADD CONSTRAINT game_results_supported_set CHECK(encode(sha256(convert_to(lower(set_id),'UTF8')),'hex') NOT IN ('f8272fb2c87fbdf3e6c933649a30f2663ba60983247b85ec223fc22b08358988','79b159b843b0aaba706b57fc165afa2d49c3680c43503ed36af6b4f66cbade5b','ca2b25a9b0e7a993f09d627d5929fb8cbfaa95403ac921f231149dc98ddce93d')) NOT VALID;
-- statement
...
-- statement
ALTER TABLE scores ADD CONSTRAINT scores_supported_set CHECK(encode(sha256(convert_to(lower(set_id),'UTF8')),'hex') NOT IN ('f8272fb2c87fbdf3e6c933649a30f2663ba60983247b85ec223fc22b08358988','79b159b843b0aaba706b57fc165afa2d49c3680c43503ed36af6b4f66cbade5b','ca2b25a9b0e7a993f09d627d5929fb8cbfaa95403ac921f231149dc98ddce93d')) NOT VALID;
-- statement
...
-- statement
ALTER TABLE share_challenges ADD CONSTRAINT share_challenges_supported_set CHECK(encode(sha256(convert_to(lower(set_id),'UTF8')),'hex') NOT IN ('f8272fb2c87fbdf3e6c933649a30f2663ba60983247b85ec223fc22b08358988','79b159b843b0aaba706b57fc165afa2d49c3680c43503ed36af6b4f66cbade5b','ca2b25a9b0e7a993f09d627d5929fb8cbfaa95403ac921f231149dc98ddce93d')) NOT VALID;
-- statement
...
-- statement
ALTER TABLE draft_run_environment_policy ADD CONSTRAINT draft_run_environment_policy_supported_set CHECK(encode(sha256(convert_to(lower(set_id),'UTF8')),'hex') NOT IN ('f8272fb2c87fbdf3e6c933649a30f2663ba60983247b85ec223fc22b08358988','79b159b843b0aaba706b57fc165afa2d49c3680c43503ed36af6b4f66cbade5b','ca2b25a9b0e7a993f09d627d5929fb8cbfaa95403ac921f231149dc98ddce93d')) NOT VALID;
-- statement
...
-- statement
ALTER TABLE draft_run_sets ADD CONSTRAINT draft_run_sets_supported_set CHECK(encode(sha256(convert_to(lower(set_id),'UTF8')),'hex') NOT IN ('f8272fb2c87fbdf3e6c933649a30f2663ba60983247b85ec223fc22b08358988','79b159b843b0aaba706b57fc165afa2d49c3680c43503ed36af6b4f66cbade5b','ca2b25a9b0e7a993f09d627d5929fb8cbfaa95403ac921f231149dc98ddce93d')) NOT VALID;
-- statement
