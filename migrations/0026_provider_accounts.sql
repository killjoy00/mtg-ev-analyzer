...
-- deliberately not persisted; signed webhooks request authoritative scheduled reconciliation.
...
-- Store only a digest for retry deduplication, never webhook bodies or tokens.
