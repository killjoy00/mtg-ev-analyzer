...
export function compactDraftRunFeedback(answer) {
  ...
  const withChoice=message=>selectedName
    ? `You chose ${selectedName}. ${message}`
    : message;
