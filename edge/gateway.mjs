...
function permitted(service,path,method,search,mode) {
  ...
  if(service==='growth') {
    if(method==='POST'&&[
      ...
      '/v1/account/signup','/v1/account/signin','/v1/account/request-password-reset','/v1/account/reset-password','/v1/account/password-change','/v1/account/email-change','/v1/account/migrate',
