...
| Practice | ✓ | Regular + Cube + custom sets | Regular + Cube + custom sets | Required |
...
| Elite capability resolution | ✓ | Server-authoritative | Server-authoritative | Required |
| Custom-set practice | ✓ | Set picker | Set picker | Required |
| Store subscription purchase | — | — | — | Required mobile |
| Restore purchases | — | — | — | Required mobile |
| Patreon entitlement recognition | ✓ | Existing grants | Existing grants | Required |
