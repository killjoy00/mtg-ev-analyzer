...
3. Apply migrations 0012–0014 to development before production; migration 0014 is additive and preserves existing schedules. Publish the eight/ten-pick compatible frontend before activating the new backend. The old frontend assumes ten rounds.
